...
The degrees of freedom are off by 2. Two participants (25 and 65) are being excluded from our analysis because they have missing data for the PAST condition.
...
For the ANOVA, we noted that two participants (25 and 65) had missing data for the PAST condition. There is no mention of missing data or participant exclusions in the article. The degrees of freedom reported in the paper appear to reflect that the participants *were* included in this analysis - but that should not be possible because of the missing data. There is a similar degrees of freedom for the t-test comparing PAST conditions.

There were two major errors with p-values where the authors reported that p = .001 but perhaps meant to report that p < .001.
